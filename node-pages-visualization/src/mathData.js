...
export const MATH_COURSE_INFO = {
  ...
  COMMST_A:   { name: 'Communication (1)',                 type: 'commst', note: 'First communications requirement', placeholder: true },
  ...
  COMMST_B:   { name: 'Communication (2)',                 type: 'commst', note: 'Second communications requirement', placeholder: true },
